...
## 1.1: Work with Oracle SSI Recipe Integration for Google Contacts to Google Sheets
...
## **1.4.1:**	Configure Process Endpoints

**1.4.1.1:**   On the SSI Home page, upper right hand side corner drop down click on the “My Cloud App Accounts”

**1.4.1.2:**  Click on the ”Authorize Cloud App Account” button
 
**1.4.1.3:**   Select “Oracle Process Cloud” from the list of Cloud Apps

**1.4.1.4:**  Provide correct values for the 3 form fields:
...
**1.4.2.3:**   Select “Oracle Integration Cloud” from the list of Cloud Apps
